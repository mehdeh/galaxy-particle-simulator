...
3. Navigate to `http://localhost:8000/galaxy.html` in your browser (if using a local server)

## 🎮 Usage

Simply open `galaxy.html` in your web browser to start the simulation. Use the control panel on the left to customize your galaxy!
